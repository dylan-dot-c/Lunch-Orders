<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddLunch.aspx.cs" Inherits="Lunch_Orders.AddLunch" %>
    ...
    <main class="w-75 m-auto">
        ...
        <div class="row mb-2">
            ...
            <div class="col mb-2">
                ...
                <asp:RequiredFieldValidator ID="rfvDate" ControlToValidate="txtDate" InitialValue="" ErrorMessage="Date selection is required." runat="server" ValidationGroup="lunchValidation" CssClass="text-danger" />
        ...
        <asp:Button ID="btnAddLunch" CssClass="btn btn-primary mt-4" runat="server" Text="Add Lunch" OnClick="btnAddLunch_Click" ValidationGroup="lunchValidation" />
    </main>
